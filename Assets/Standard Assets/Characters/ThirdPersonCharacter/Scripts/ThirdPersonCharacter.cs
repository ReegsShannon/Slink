...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		void Start()
		{
			...
			body = GameObject.Find ("EthanBody").GetComponent<SkinnedMeshRenderer> ();
			glasses = GameObject.Find ("EthanGlasses").GetComponent<SkinnedMeshRenderer> ();
		}
